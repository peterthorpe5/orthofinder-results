...
@pytest.fixture
def benchmark_application_resource(application_resource: Path) -> Path:
    """Add compact successful benchmark relations to the application fixture."""
    ...
    try:
        ...
        connection.execute(
            ...
            "distance_sd_control_percentile,heterogeneity_class,classification_rule,"
            "status)"
        )
        connection.execute("CHECKPOINT")
    finally:
